    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card mt-2">
          ...
          <div class="card-body">
            <form action="../config/aksi_foto.php" method="POST" enctype="multipart.from-data">
                ...
                while($data = mysqli_fetch_array($sql)) {
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?php echo $data['fotoid'] ?>"> Edit 
                      </button>
                              ...
                              <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-8">
                                    ...
                                    <input type="file" class="form-control" name="lokasifoto">
                                  </div>
                                </div>
...
<footer class="d-flex justify-content-center border-top mt-3 bg-danger-subtle fixed-bottom">
  <p>&copy; UKK RPL 2024 | Anisyah Ramadani </p>
</footer>
